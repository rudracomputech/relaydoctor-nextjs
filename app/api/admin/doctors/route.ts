...
export async function POST(req: Request) {
  try {
    ...
    const newDoctor = await User.create({
      ...
      additionalAddresses: Array.isArray(additionalAddresses) ? additionalAddresses : [],
      ...
      workSchedule: workSchedule || {
        ...
        surgeryTiming: 'MON-FRI | 2 PM TO 5 PM',
        surgeryDays: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri'],
      },
      availabilityStatus: availabilityStatus || 'Available For Call',
